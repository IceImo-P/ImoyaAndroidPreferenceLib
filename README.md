...
5. Add dependencies to your module's `build.gradle`:
    ...
    dependencies {
        // (other dependencies)
        implementation 'net.imoya.android.dialog:imoya-android-dialog:2.2.1'
        implementation 'net.imoya.android.fragment:imoya-android-fragment:1.6.0'
        implementation 'net.imoya.android.log:imoya-android-log:1.3.1'
        implementation 'net.imoya.android.preference:imoya-android-preference:2.4.0'
