 ...
 * with [SingleSelectionListEditorActivity]
 */
open class SingleSelectionListEditorFragmentOnActivity :
    SingleSelectionListEditorFragment() {

    override fun notifyResultToHost(position: Int) {
        val data = Intent()
        data.putExtra(
