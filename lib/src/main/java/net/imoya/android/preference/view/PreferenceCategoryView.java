 ...
 * </ul></p>
 * <h2>カスタムレイアウト</h2>
 * <p>レイアウトXMLへ {@link PreferenceCategoryView} を配置する際、 android:layout
 * ({@link android.R.attr#layout})
 * 属性を指定することで、自由に定義されたレイアウトを適用することができます。</p>
 * <p>適用するレイアウトは、最低限次の規則に従ってください:<ul>
 * <li>ルート要素は {@link FrameLayout} へキャスト可能なクラスとしてください。</li>
 * <li>title 文言表示のため、IDが &quot;@android:id/title&quot;
 * ({@link android.R.id#title})である {@link TextView} を配置してください。</li>
 * </ul></p>
 */
public class PreferenceCategoryView extends FrameLayout implements PreferenceItemView {
    /**
     * 状態オブジェクト
     */
    ...
    private static final String TAG = "PreferenceCategoryView";
    ...
    public PreferenceCategoryView(Context context) {
        super(context);
        Log.d(TAG, "PreferenceCategoryView#__construct(c): start. class = " + this.getClass().getSimpleName() + ", instance = " + super.toString());
        this.state = this.createState();
        this.init(context, null, 0, 0);
        Log.d(TAG, "PreferenceCategoryView#__construct(c): end. class = " + this.getClass().getSimpleName() + ", instance = " + super.toString());
    }
    ...
    public PreferenceCategoryView(Context context, AttributeSet attrs) {
        super(context, attrs);
        Log.d(TAG, "PreferenceCategoryView#__construct(c,a): start. class = " + this.getClass().getSimpleName() + ", instance = " + super.toString());
        this.state = this.createState();
        this.init(context, attrs, 0, 0);
        Log.d(TAG, "PreferenceCategoryView#__construct(c,a): end. class = " + this.getClass().getSimpleName() + ", instance = " + super.toString());
    }
    ...
    public PreferenceCategoryView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        Log.d(TAG, "PreferenceCategoryView#__construct(c,a,i): start. class = " + this.getClass().getSimpleName() + ", instance = " + super.toString());
        this.state = this.createState();
        this.init(context, attrs, defStyleAttr, 0);
        Log.d(TAG, "PreferenceCategoryView#__construct(c,a,i): end. class = " + this.getClass().getSimpleName() + ", instance = " + super.toString());
    }
...
//        Log.d(TAG, "PreferenceCategoryView#__construct(c,a,i1,i2): start. class = " + this.getClass().getSimpleName());
    ...
    protected void loadAttributes(TypedArray values) {
        ...
        Log.d(TAG, "loadAttributes: title = " + this.state.title + ", dependency = " + this.dependency);
    }
