...
import net.imoya.android.preference.fragment.editor.time.TimePeriodEditorFragmentOnActivity
import net.imoya.android.preference.model.TimePeriod

/**
 * [TimePeriod] 入力画面
 */
open class TimePeriodEditorActivity : PreferenceEditorActivityWithFragment() {
